...
class HybridSearchValidator:
    ...
    def measure_search_quality(self, test_queries: List[Dict[str, Any]]) -> Dict[str, float]:
        ...
        return {
            ...
            'precision_improvement': (
                ...
                / statistics.mean(vector_precision_scores) * 100 
                if vector_precision_scores and statistics.mean(vector_precision_scores) > 0 else 0.0
            )
        }
    ...
    def run_performance_validation(self) -> Dict[str, Any]:
        ...
        test_queries = [
            {
                ...
                'ground_truth': ['chunk1', 'chunk2']  # Expected chunks containing UserController
            },
            {
                'query': 'authentication middleware',
                'ground_truth': ['chunk3', 'chunk4']  # Expected chunks for auth concepts
            },
            {
        ...
        if all([hybrid_latency['mean_ms'] < 100.0, quality_metrics['precision_improvement'] >= 20.0]):
