...
class TestRepoWatcher:
    ...
    @patch("kb.ingest.watcher.load_repo_ignores")
    async def test_init(self, mock_load_ignores, mock_get_branch, mock_pipeline, config):
        mock_load_ignores.return_value = (set(), set())
    ...
    @patch("kb.ingest.watcher.get_current_branch_state")
    @patch("kb.ingest.watcher.load_repo_ignores")
    async def test_filter_changes(self, mock_load_ignores, mock_get_branch, mock_pipeline, config):
        mock_load_ignores.return_value = (set(), set())
        mock_get_branch.return_value = BranchState(branch="main", commit_sha="123")
    ...
    @patch("kb.ingest.watcher.get_current_branch_state")
    @patch("kb.ingest.watcher.load_repo_ignores")
    async def test_check_branch_switch_no_change(self, mock_load_ignores, mock_get_branch, mock_pipeline, config):
        mock_load_ignores.return_value = (set(), set())
        mock_get_branch.return_value = BranchState(branch="main", commit_sha="123")
    ...
    @patch("kb.ingest.watcher.get_current_branch_state")
    @patch("kb.ingest.watcher.load_repo_ignores")
    async def test_check_branch_switch_detected(self, mock_load_ignores, mock_get_branch, mock_pipeline, config):
        mock_load_ignores.return_value = (set(), set())
    ...
    @patch("kb.ingest.watcher.get_current_branch_state")
    @patch("kb.ingest.watcher.load_repo_ignores")
    async def test_record_changes(self, mock_load_ignores, mock_get_branch, mock_pipeline, config):
        mock_load_ignores.return_value = (set(), set())
        mock_get_branch.return_value = BranchState(branch="main", commit_sha="123")
    ...
    @patch("kb.ingest.watcher.get_current_branch_state")
    @patch("kb.ingest.watcher.load_repo_ignores")
    async def test_process_pending_sync(self, mock_load_ignores, mock_get_branch, mock_pipeline, config):
        mock_load_ignores.return_value = (set(), set())
        mock_get_branch.return_value = BranchState(branch="main", commit_sha="123")
