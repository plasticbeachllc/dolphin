...
class TestMaximalMarginalRelevance:
    ...
    def test_diversification(self):
        ...
        candidates = [
            ...
            {"chunk_id": "B", "score": 0.85, "query_vector": query_vector},  # Very similar
            {"chunk_id": "C", "score": 0.8, "query_vector": [-0.1, -0.2, -0.3]},  # Different
        ]
    ...
    def test_lambda_parameter(self):
        ...
        candidates = [
            ...
            {"chunk_id": "B", "score": 0.80, "query_vector": query_vector},  # Same as A, high relevance
            {"chunk_id": "C", "score": 0.50, "query_vector": [-0.1, -0.2, -0.3]},  # Low score but very diverse
            {"chunk_id": "D", "score": 0.45, "query_vector": [0.1, 0.2, 0.3]},  # Medium score, same vector as A
        ]
