...
describe("express.text()", function () {
  ...
  describe("with inflate option", function () {
    describe("when false", function () {
      ...
      it("should not accept content-encoding", function (done) {
        ...
        test.set("Content-Type", "text/plain");
        test.write(
          Buffer.from("1f8b080000000000000bcb4bcc4d55c82c5678b16e170072b3e0200b000000", "hex")
        );
  ...
  describe("async local storage", function () {
    ...
    it("should persist store when inflate error", function (done) {
      ...
      test.set("Content-Type", "text/plain");
      test.write(
        Buffer.from("1f8b080000000000000bcb4bcc4d55c82c5678b16e170072b3e0200b0000", "hex")
      );
      test.expect(400);
      test.expect("x-store-foo", "bar");
      test.end(done);
