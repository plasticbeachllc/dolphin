...
describe("express.json()", function () {
  ...
  describe("with inflate option", function () {
    describe("when false", function () {
      ...
      it("should not accept content-encoding", function (done) {
        ...
        test.set("Content-Type", "application/json");
        test.write(
          Buffer.from("1f8b080000000000000bab56ca4bcc4d55b2527ab16e97522d00515be1cc0e000000", "hex")
        );
  ...
  describe("async local storage", function () {
    ...
    it("should persist store when inflate error", function (done) {
      ...
      test.set("Content-Type", "application/json");
      test.write(
        Buffer.from("1f8b080000000000000bab56cc4d55b2527ab16e97522d00515be1cc0e000000", "hex")
      );
      test.expect(400);
      test.expect("x-store-foo", "bar");
      test.end(done);
