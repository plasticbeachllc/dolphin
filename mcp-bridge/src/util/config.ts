...
export function validateConfig(): string[] {
  ...
  if (
    CONFIG.RESPONSE_LIMITS.SHRUNK_SNIPPET_CHAR_CAP < CONFIG.RESPONSE_LIMITS.MIN_SNIPPET_CHAR_FLOOR
  ) {
    warnings.push(
  ...
  if (CONFIG.RESPONSE_LIMITS.SHRUNK_SNIPPET_CHAR_CAP > CONFIG_LIMITS.MAX_SHRUNK_SNIPPET_CHAR_CAP) {
    warnings.push(
