...
# Test queries appropriate for each repo type - expanded for better profiling
case $REPO_SIZE in
  small)
    # Express.js queries (50 queries)
    QUERIES=(
  ...
  medium)
    ...
    ;;
  large)
    # Linux kernel queries (50 queries)
    QUERIES=(
